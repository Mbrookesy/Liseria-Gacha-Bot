    ...
    async def blackjack(self, ctx):
        ...
        if folded:
            ...
            if dealer_value > max_value:
                await ctx.send(f"```The dealer has a value of {dealer_value}, higher than your value of {max_value} You Lose.```")
            elif dealer_value < max_value:
                await ctx.send(f"```The dealer has a value of {dealer_value}, lower than your value of {max_value} You Win!```")
            else:
                await ctx.send(
                    f"```You both got the same value, you draw.```")